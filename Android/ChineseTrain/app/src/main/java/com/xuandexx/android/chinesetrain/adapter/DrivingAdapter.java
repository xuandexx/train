...
public class DrivingAdapter extends BaseAdapter{
	...
	public DrivingAdapter(Context context,List<DrivingSchoolEntity> data){
		this.list_data = data;
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			...
			Holder.das_rl_sex = (RelativeLayout) convertView.findViewById(R.id.das_rl_sex);
			Holder.ds_tv_jl = (TextView) convertView.findViewById(R.id.ds_tv_jl);
			Holder.ds_tv_jl.setVisibility(View.VISIBLE);
			Holder.das_rl_sex.setVisibility(View.VISIBLE);
	...
	public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
		DrivingAdapter.isSelected = isSelected;
	}
    class ViewHolder{
    	private ImageView ds_img_icon,ds_img_level;
    	private TextView ds_tv_name,ds_tv_address,ds_tv_regional,ds_tv_jl;
    	private RelativeLayout das_rl_sex;
    	private CheckBox cb;
    }
}