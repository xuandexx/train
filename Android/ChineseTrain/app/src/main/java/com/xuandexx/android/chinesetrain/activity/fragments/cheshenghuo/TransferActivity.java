...
//过户类型
public class TransferActivity extends MyActivity implements OnWheelChangedListener{
	...
	private void initJsonData() {
		try {
			...
			InputStream is = getAssets().open("transfer.json");
			int len = -1;
	...
	private void initDatas() {
		try {
			JSONArray jsonArray = mJsonObj.getJSONArray("transferlist");
