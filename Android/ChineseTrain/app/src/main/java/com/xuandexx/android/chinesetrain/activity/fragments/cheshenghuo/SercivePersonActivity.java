 ...
 * 
 */
public class SercivePersonActivity extends MyActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.serviceproviders);
		((TextView) findViewById(R.id.view_top_tv_title))
				.setText(R.string.title_activity_service_person);
	...
	private void initView() {
		...
		Certification = (TextView) findViewById(R.id.serviceproviders_Certification);
		...
		try {
			...
			if (mCertification == 1) {
				Certification.setText("身份证已认证");
				Certification.setTextColor(Color.RED);
			} else {
				Certification.setText("身份证未认证");
	...
	private OnClickListener l = new OnClickListener() {
		...
		public void onClick(View V) {
			...
			case R.id.serviceproviders_viewLocation:
				...
				(SercivePersonActivity.this, MapActivity.class);
			...
			case R.id.serviceproviders_ViewPersonalInformation:
				Intent intent2=new Intent(SercivePersonActivity.this,FriendInfoActivity.class);
				intent2.putExtra("name","fdfd");
				startActivity(intent2);				
				break;
			case R.id.serviceproviders_Phone:
				ibuilder = new CustomDialog.Builder

				(SercivePersonActivity.this);
				...
				break;
			case R.id.serviceproviders_address:
				Intent intent3=new Intent(SercivePersonActivity.this,MapActivity.class);
