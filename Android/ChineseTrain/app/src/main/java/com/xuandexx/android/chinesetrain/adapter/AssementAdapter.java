...
import cn.ieauto.autogroup.android.activity.fragments.cheshenghuo.TransferFragmentAssignment;
import cn.ieauto.autogroup.android.adapter.AutoBeautyAdapter.ViewHolder;
import cn.ieauto.autogroup.android.entity.ComPanyEnity;

public class AssementAdapter extends BaseAdapter{
	private Context mContext;
	private List<ComPanyEnity> list_data;
	// 用来控制CheckBox的选中状况
	private static HashMap<Integer, Boolean> isSelected;

	public AssementAdapter(Context context, List<ComPanyEnity> data) {
		this.list_data = data;
		...
		holder.ls_img_icon.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent = new Intent(mContext,
						TransferFragmentAssignment.class);
	...
	public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
		AssementAdapter.isSelected = isSelected;
	}
