 ...
 * 
 */
public class CarTypeActivity extends MyActivity implements
	...
	private void initJsonData() {
		try {
			...
			InputStream is = getAssets().open("carmodles.json");
			int len = -1;
	...
	private void initDatas() {
		try {
			JSONArray jsonArray = mJsonObj.getJSONArray("carlist");
