 ...
 * 
 */
public class Auto_Beauty extends Fragment implements OnClickListener {
	private ListView listview;
	private Activity mActivity;
	private View view;
	private DrivingAdapter mAdapter;
	private List<DrivingSchoolEntity> list_data;
	private String [] name = {"联动","苏绣","当军"};
	private String [] addres = {"上海市","上海市","上海市"};
	private String [] phone = {"曹杨路1321号距离100米","曹杨路1321号距离100米","金沙江路25号距离100米"};
	...
	public void onClick(View v) {
		...
		case R.id.ai_ll_evaluation:
            ...
            startActivityForResult(aiintent, ComConfig.INTENT_SORT_BY);
			break;
		case R.id.sd_btn_ok:
