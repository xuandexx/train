...
public class GearActivity extends MyActivity implements OnWheelChangedListener{
...
//			updateAreas();
	...
	private void initJsonData() {
		try {
			...
			InputStream is = getAssets().open("carGear.json");
			int len = -1;
	...
	private void initDatas() {
		try {
			JSONArray jsonArray = mJsonObj.getJSONArray("carGearlist");
