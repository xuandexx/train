...
//排序
public class SequenceActivity extends MyActivity implements OnWheelChangedListener{
	...
	private void initJsonData() {
		try {
			...
			InputStream is = getAssets().open("sequence.json");
			int len = -1;
	...
	private void initDatas() {
		try {
			JSONArray jsonArray = mJsonObj.getJSONArray("sequencelist");
