...
public class CarSafeActivity extends MyActivity implements OnWheelChangedListener{
...
//			updateAreas();
	...
	private void initJsonData() {
		try {
			...
			InputStream is = getAssets().open("carSafe.json");
			int len = -1;
	...
	private void initDatas() {
		try {
			JSONArray jsonArray = mJsonObj.getJSONArray("carSafelist");
