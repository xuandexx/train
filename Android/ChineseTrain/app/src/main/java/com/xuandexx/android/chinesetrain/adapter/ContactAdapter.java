	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (position == 0) {// 搜索框
			...
			if (username.equals(ComConfig.NEW_FRIENDS_USERNAME)) {
				...
				avatar.setImageResource(R.drawable.d1_008_1);
			...
			} else if (username.equals(ComConfig.FIND_NEW_FRIENDS)) {
				// 寻找新朋友
				nameTextview.setText(user.getNick());
				avatar.setImageResource(R.drawable.d1_008_2);
			} else if (username.equals(ComConfig.GROUP_USERNAME)) {
				// 群聊item
				nameTextview.setText(user.getNick());
				avatar.setImageResource(R.drawable.d1_008_4);
			} else {
