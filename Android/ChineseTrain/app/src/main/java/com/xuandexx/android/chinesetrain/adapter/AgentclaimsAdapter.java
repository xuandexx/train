...
public class AgentclaimsAdapter extends BaseAdapter{
	...
	public AgentclaimsAdapter(Context context,List<InsuranceEntity> data){
		this.list_data = data;
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		InsuranceEntity entity = list_data.get(position);
		ViewHolder holder;
		if (convertView == null) {
	...
	public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
		AgentclaimsAdapter.isSelected = isSelected;
	}
   class ViewHolder{
