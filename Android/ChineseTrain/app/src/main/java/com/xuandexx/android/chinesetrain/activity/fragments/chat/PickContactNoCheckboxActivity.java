...
public class PickContactNoCheckboxActivity extends MyActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView = (ListView) findViewById(R.id.pcnc_lv_list);
	...
	private void getContactList() {
		...
		while (iterator.hasNext()) {
			...
			if (!entry.getKey().equals(ComConfig.NEW_FRIENDS_USERNAME)
					&& !entry.getKey().equals(ComConfig.GROUP_USERNAME)&& !entry.getKey().equals(ComConfig.FIND_NEW_FRIENDS))
